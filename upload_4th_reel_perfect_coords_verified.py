...
def run():
    print("==================================================")
    print(" Guaranteed 4th Reel Upload Sequence             ")
    print("==================================================")
    ...
    with sync_playwright() as p:
        ...
        page.screenshot(path=str(ROOT_DIR / "downloads" / "step1_create_flyout.png"))
        ...
        page.screenshot(path=str(ROOT_DIR / "downloads" / "step2_modal_verified.png"))
        print("Saved step2_modal_verified.png")

        # 4. Attach video file
        print("4. Attaching NEW video file reel_to_upload_3.mp4...")
        ...
        page.screenshot(path=str(ROOT_DIR / "downloads" / "step3_video_in_dialog.png"))
        ...
        page.screenshot(path=str(ROOT_DIR / "downloads" / "final_4th_reel_verified_published.png"))
        print("\n==================================================")
