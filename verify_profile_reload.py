...
def run():
    print("==================================================")
    print(" Refreshing Profile Page to Confirm Post Count    ")
    print("==================================================")
    ...
    with sync_playwright() as p:
        ...
        print("Opening @tune_of_ghibli profile page...")
        ...
        page.screenshot(path=str(ROOT_DIR / "downloads" / "profile_reloaded_grid.png"))
        print("✓ Captured profile_reloaded_grid.png")
