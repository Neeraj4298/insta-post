...
def run():
    print("==================================================")
    print(" Exact Role='button' Share Click Submission Flow  ")
    print("==================================================")
    ...
    with sync_playwright() as p:
        ...
        # Step 4: Click exact Share role=button in header
        print("Step 4: Clicking exact role='button' Share element...")
        share_btn = page.locator("div[role='dialog'] header div[role='button']").last
        share_btn.wait_for(state="visible", timeout=5000)
        share_btn.click(force=True)
        print("✓ Clicked header role='button' Share element successfully!")

        print("5. Waiting 30 seconds for Instagram server rendering & posting...")
        time.sleep(30)

        # Capture final shared confirmation dialog
        page.screenshot(path=str(ROOT_DIR / "downloads" / "final_shared_confirmation_dialog.png"))
        print("\n==================================================")
