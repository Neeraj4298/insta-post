...
def run():
    print("==================================================")
    print(" Uploading 4th Reel with Strict Home Lock        ")
    print("==================================================")
    ...
    with sync_playwright() as p:
        ...
        if "tune_of_ghibli" in page.url:
            print("Currently on profile, navigating to Home feed...")
            page.locator("svg[aria-label='Home']").first.click()
            time.sleep(4)

        page.screenshot(path=str(ROOT_DIR / "downloads" / "home_locked_feed.png"))
        ...
        page.screenshot(path=str(ROOT_DIR / "downloads" / "create_menu_open.png"))
        ...
        page.screenshot(path=str(ROOT_DIR / "downloads" / "create_modal_opened.png"))
        print("Saved create_modal_opened.png")
        ...
        page.screenshot(path=str(ROOT_DIR / "downloads" / "video_loaded_modal_confirm.png"))
        ...
        page.screenshot(path=str(ROOT_DIR / "downloads" / "final_4th_reel_modal_shared.png"))
        print("\n==================================================")
