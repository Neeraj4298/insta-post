...
def run():
    print("==================================================")
    print(" Uploading BRAND NEW Reel (4th Post) to Instagram ")
    print("==================================================")
    ...
    with sync_playwright() as p:
        ...
        page.screenshot(path=str(ROOT_DIR / "downloads" / "new_reel_dialog.png"))

        # Set input file
        print("Attaching NEW reel video file to upload dialog...")
        file_input = page.locator("input[type='file']").first
        file_input.wait_for(state="attached", timeout=10000)
        file_input.set_input_files(VIDEO_PATH)
        print("✓ Attached new reel video file successfully!")
        time.sleep(6)
        ...
        print("Waiting 25 seconds for video upload and Instagram post processing...")
        time.sleep(25)

        # Navigate to profile to verify 4th post
        print("Navigating to @tune_of_ghibli profile...")
        page.goto("https://www.instagram.com/tune_of_ghibli/", wait_until="domcontentloaded")
        time.sleep(4)

        page.screenshot(path=str(ROOT_DIR / "downloads" / "profile_4th_post_published.png"))
        print("\n==================================================")
