...
VIDEO_PATH = str(ROOT_DIR / "downloads" / "reel_to_upload_2.mp4")
...
def run():
    print("==================================================")
    print(" Uploading 2nd Reel to @tune_of_ghibli           ")
    print("==================================================")
    ...
    with sync_playwright() as p:
        ...
        page.screenshot(path=str(ROOT_DIR / "downloads" / "second_reel_dialog.png"))
        ...
        print("✓ Attached second reel video file successfully!")
        time.sleep(6)
        ...
        page.screenshot(path=str(ROOT_DIR / "downloads" / "final_second_reel_profile.png"))
        print("\n==================================================")
        print(" 🎉 SECOND REEL PUBLISHED SUCCESSFULLY ON INSTAGRAM!")
        print("==================================================")
